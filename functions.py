...
def desktop_notification(message):
    ...
    notification.icon = r'blaze-icon.png'
    notification.send()
...
def apostar(lista, bot_telegram):
    ...
    if lista[0]['cor'] == 2:
        ...
        while True:
            try:
                bot_telegram.send_message('894633998', '\U0001f916 Robô da Safablaze \U0001f916 \n\nApostar no vermelho e no branco. \U0001f534 \u26aa')
                break
    ...
    if list[0]['cor'] != list[1]['cor']:
        ...
        while True:
            try:
                bot_telegram.send_message('894633998', '\u2705 \u2705 \u2705 \u2705 \nWIIINNN')
                break
            except Exception as e:
                print('Erro:', e)
        win += 1
        ...
        while True:
            try:
                bot_telegram.send_message('894633998', '\u26a0\ufe0f \u26a0\ufe0f \u26a0\ufe0f \u26a0\ufe0f  \nVamos para a primeira gale. \nDobre a aposta e repita a cor')
                break
            except Exception as e:
                print('Erro:', e)
        print('Primeira gale')
